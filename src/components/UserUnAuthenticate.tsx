...
function UserUnAuthenticate({ redirectUrl }: { redirectUrl?: string }) {
  const router = useRouter();

  const handleLogin = () => {
    const target = redirectUrl ? `/sign-in?redirect=${redirectUrl}` : '/sign-in';
...
export default UserUnAuthenticate;
