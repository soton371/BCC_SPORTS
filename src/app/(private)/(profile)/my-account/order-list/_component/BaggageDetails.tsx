...
const BaggageDetails = ({ orderId }: { orderId: string }) => {
  const { data: order, isLoading, isSuccess } = useGetBaggageOrderDetailsQuery(orderId);
              ...
              <div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm'>
                  ...
                  <div>
                    ...
                    <Badge variant='outline'>Baggage Wrapping</Badge>
                  </div>
                  <div>
